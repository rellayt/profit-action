"""Generate Zod schemas from Pydantic models (OpenAPI SoT companion)."""
...
from app.models.analysis import AnalysisPlan, AnalysisResult  # noqa: E402
from app.models.catalog import ProductsResponse  # noqa: E402
from app.models.chat import (  # noqa: E402
    AnalysisDataPart,
    StatusDataPart,
    UnsupportedDataPart,
)
from app.models.conversation import ConversationDetail, ConversationSummary  # noqa: E402
from app.models.health import HealthResponse  # noqa: E402

OUT = ROOT / "frontend" / "src" / "contracts" / "generated" / "schemas.ts"
...
def emit_health_and_stream() -> str:
    return '''\
...
def main() -> None:
    # Touch models so export stays coupled to Pydantic (fail if imports break).
    for model in (
        AnalysisPlan,
        AnalysisResult,
        ProductsResponse,
    ...
    body = HEADER + emit_analysis_result() + emit_catalog() + emit_conversation() + emit_health_and_stream()
